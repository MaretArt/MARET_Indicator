...
float R1 = 100000.00;           // define resistor 1 of voltage divider
float R2 = 10000.00;            // define resistor 2 of voltage divider
...
/*
    ...
    R1 (default = 100000.00)
    R2 (default = 10000.00)
    battery voltage is MORE or LESS than VREF (default = MORE) *if LESS see batterytest2.ino
    type: BUZZER / BATTERY / LED (default = BATTERY)
*/
MARET_Indicator battery(pinBattery, pinRed, pinGreen, pinBlue, VREF, lowVoltage, normalVoltage, fullVoltage, R1, R2, MORE, BATTERY);
